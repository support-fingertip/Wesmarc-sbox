({
    ...
    helperSaveStartDay : function (component, event,helper) {
        try{
            component.set('v.spinner', true);
            var positionIn = component.get('v.StartTime');
            var action = component.get("c.createAttendanceStartDay");
            action.setParams({ 
            ...
            action.setCallback(this, function(response) {
                ...
                if (actionResponse == "SUCCESS") {
                    ...
                    helper.showToast("Started Day Successfully..!", "success");
    ...
    helperSaveEndDay : function (component, event,helper) {
        try{
            component.set('v.spinner', true);
            var positionIn = component.get('v.EndTime');
            var action = component.get("c.updateAttendanceEndDay");
            action.setParams({ 
                latitude: positionIn.coords.latitude,
                longitude: positionIn.coords.longitude
            });
            action.setCallback(this, function(response) {
                ...
                if (actionResponse == "SUCCESS") {
                    component.set('v.spinner', false);
                    component.set('v.isDisabled', true);
                    helper.showToast("Ended Day Successfully..!", "error");
                    $A.get("e.force:closeQuickAction").fire();
                    $A.get('e.force:refreshView').fire();  
